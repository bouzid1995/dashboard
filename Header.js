...
export default class Header extends Component {
  ...
  <nav className="navbar navbar-static-top">
    ...
    <a href="fake_page" className="sidebar-toggle" data-toggle="push-menu" role="button">
    ...
    <div className="navbar-custom-menu">
      <ul className="nav navbar-nav">
        ...
        <li className="dropdown messages-menu">
          <a href="fake_page" className="dropdown-toggle" data-toggle="dropdown">
          ...
          <ul className="dropdown-menu">
            ...
            <li className="footer"><a href="fake_page">See All Messages</a></li>
          </ul>
        </li>
        ...
        <li className="dropdown notifications-menu">
          ...
          <ul className="dropdown-menu">
            ...
            <li className="footer"><a href="fake_page">View all</a></li>
          </ul>
        </li>
        ...
        <li className="dropdown tasks-menu">
          ...
          <ul className="dropdown-menu">
            ...
            <li className="footer">
              <a href="fake_page">View all tasks</a>
            </li>
          </ul>
        </li>
        ...
        <li className="dropdown user user-menu">
          ...
          <ul className="dropdown-menu">
            ...
            <li className="user-body">
              <div className="row">
                <div className="col-xs-4 text-center">
                  <a href="fake_page">Followers</a>
                </div>
                <div className="col-xs-4 text-center">
                  <a href="fake_page">Sales</a>
                </div>
                <div className="col-xs-4 text-center">
                  <a href="fake_page">Friends</a>
                </div>
              </div>
              {/* /.row */}
            </li>
            ...
            <li className="user-footer">
              <div className="pull-left">
                <a href="fake_page" className="btn btn-default btn-flat">Profile</a>
              </div>
              <div className="pull-right">
                <a href="fake_page" className="btn btn-default btn-flat">Sign out</a>
              </div>
            </li>
          </ul>
        </li>
        ...
        <li>
          <a href="fake_page" data-toggle="control-sidebar"><i className="fa fa-gears" /></a>
        </li>
      </ul>
    </div>
  </nav>
