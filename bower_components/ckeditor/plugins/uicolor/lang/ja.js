...
*/
CKEDITOR.plugins.setLang("uicolor","ja",{title:"UIカラーピッカー",options:"Color Options",highlight:"Highlight",selected:"Selected Color",predefined:"既定カラーセット",config:"この文字列を config.js ファイルへ貼り�﻿/*
 Copyright (c) 2003-2019, CKSource - Frederico Knabben. All rights reserved.
 For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
*/
